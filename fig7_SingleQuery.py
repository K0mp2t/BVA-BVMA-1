...
if __name__=='__main__':
    ...
    plt.plot(QueryList, SISizeList,  linestyle = '--', color = 'g',label='Search')
    plt.plot(QueryList, BVAISizeList, linestyle = '-.', color = 'b',label='BVA')
    plt.plot(QueryList, BVMAISizeList, linestyle = ':', color = 'r',label='BVMA')
    plt.legend()
    plt.grid(axis='x')
    plt.yscale('log')  
